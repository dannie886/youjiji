...
function proceedCheckout(){
	var winH = h-70;
	window.open(site_config.site_url+'pay/index.php?package='+creditsPackage+'&type=credits','popUpWindow','height='+winH+',width=670,left=450,top=100,resizable=no,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');	
}
...
function purchasePremium(el){
	...
	var winH = h-70;
	window.open(site_config.site_url+'pay/index.php?package='+package+'&type=premium','popUpWindow','height='+winH+',width=670,left=450,top=100,resizable=no,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');	
	/*
